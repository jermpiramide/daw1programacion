...
public class U03ejerc07 {
    ...
    public static void arrayDesplaza1(double[] array){
        ...
        // El índice del último elemento de un array siempre es igual a la longitud del array menos una unidad
        // (porque el índice de la primer posición de un array es 0.

        for(int i=(array.length-1); i>=1; i--){
            // Empezamos por el final del array porque hemos guardado en aux el valor de la última posición del array,
            // pero también es posible hacerlo al revés: guardar en aux el valor del primer elemento del array y
            // y recorrer el bucle del principio al final.
