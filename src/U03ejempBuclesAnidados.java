    ...
    public static void main(String args[]){
        ...
        for(int i=1; i<=10; i++){
            for(int j=1; j<=10; j++) {
                ...
                // caracteres hasta alcanzar un mínimo de 2 caracteres en total. Si el dato es superior a la cantidad
                // mínima de caracteres indicados, se muestra el dato completo sin mostrar ningún espacio en blanco.
            }
